...
def get_org(org_slug: str, current_user: User = Depends(get_current_user)):
...
def org_delete(org_slug: str, current_user: User = Depends(get_current_user)):
...
def generate_org_invite_link(
    ...
    resp = org_service.org_link_invite(org_slug, role_data.role, request)
...
def revoke_workspace(org_slug: str, current_user: User = Depends(get_current_user)):
